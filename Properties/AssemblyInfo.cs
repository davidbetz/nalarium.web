...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("Nalarium.Web.Processing, PublicKey=dc6429114df2bd49")]
//+
namespace Nalarium.Web
{
    [Nalarium.NotDocumented]
    public class AssemblyInfo
    {
        internal static Assembly _Assembly = typeof(Nalarium.Web.AssemblyInfo).Assembly;

        //+
        public static String AssemblyName = _Assembly.FullName;
        public static Byte[] PublicKey = _Assembly.GetName().GetPublicKey();
        public static String PublicKeyString = System.Text.UTF8Encoding.UTF8.GetString(PublicKey).ToLower();
    }
}